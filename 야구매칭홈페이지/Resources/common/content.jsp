...
<div class="section">
	<div class="tab tab_type1">
		...
		<ul id="tab01" class="_no_content _notice list" style="border-bottom:1px solid black;height:150px">
			<% if(note_vector == null){ %>
					<li>공지 사항이 없습니다.</li>
			<% }else{
		...
		<ul id="tab02" class="_no_content _event list" style="display: none;border-bottom:1px solid black;height:150px">
...
<ul id="tab03"class="_co_content _game list" style="border-bottom:1px solid black;height:150px">
	<% if(mat_vector == null){ %>
	...
	%>
					<li>					
						<a href="../gesipan_matching/matchingview.jsp?idx=<%=mtb.getIndex() %>" class="_board_link"><%=mtb.getTitle()%></a>
						<span class="date"><%=mtb.getDate() %></span>
					</li>
	<%				
				}
...
<ul id="tab04" class="_co_content _free list" style="display: none;border-bottom:1px solid black;height:150px">
     <% if(free_vector == null){ %>
...
<ul id="tab05" class="_co_content _pro list" style="display: none;border-bottom:1px solid black;height:150px">
   <% if(pro_vector == null){ %>

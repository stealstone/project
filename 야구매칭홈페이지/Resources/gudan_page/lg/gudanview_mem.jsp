			...
			<fieldset>
				...
				<p></p> -->
		  		<input type="text" id="text" class="form-control"/>
			  		<form>
					  		<button class="btn btn-sm btn-primary" id="go" onclick="" style="float:right;">취소 </button> 	
					  		<button class="btn btn-sm btn-primary" id="go" onclick="" style="float:right; margin-right: 5px">등록 </button>
			  		</form>
		  		</fieldset>
		</div>
	</div>

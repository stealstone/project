...
<!-- ========== container ========== -->
		...
		<div id="divContainer">
			...
			<div id="divContent">			
				...
				<div>
					<h2 class="text_align_center">홍보 게시판</h2>
						<br />
						<table class="bbsList">
							<tbody>
							<tr>
							...
							<tr>
								<td>test</td>
								<td><a href="../gesipan_promotion/promotionview.jsp">test</a></td>
								<td>test</td>
								<td>test</td>
							</tr>											
					...
					<!-- 버튼 -->
					<form>
						<a href="../gesipan_promotion/promotionwrite.jsp"><img id="btnWrite" src="../images/write.gif" ></a></td>
					</form>
				</div>
				<!-- 게시판 끝 -->
